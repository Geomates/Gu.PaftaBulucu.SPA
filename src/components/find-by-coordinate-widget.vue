<template>
  <div class="row">    
    <div class="col-auto font-weight-bold pr-1 my-auto text-right">Enlem:</div>
    <div class="col-1 p-0">
    ...
    <div class="col-auto font-weight-bold my-auto px-1 text-right">Boylam:</div>
    <div class="col-1 p-0">
      <div class="input-group">
...
export default class FindByCoordinateWidget extends Vue {
    ...
    private find(): void {
        ...
        if (latitude > 0 && longitude > 0) {
            this.$emit('onFind', latitude, longitude, this.scale);
        }
    }
}
</script>